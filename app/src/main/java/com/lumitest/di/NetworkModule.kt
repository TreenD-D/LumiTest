...
import com.lumitest.BuildConfig
import com.lumitest.data.network.interceptor.ErrorResponseInterceptor
import com.lumitest.data.network.interceptor.HeaderInterceptor
...
internal val networkModule = module {
    ...
    single(named("AuthRetrofit")) {
        get<Retrofit.Builder>(named("AuthBuilder"))
            .baseUrl(com.lumitest.data.BuildConfig.API_ENDPOINT).build()
    }
